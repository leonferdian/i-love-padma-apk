...
import com.project45.ilovepadma.timeline.add_timeline2;
...
public class list_complain_by_note extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_cust_service2.CustomerListener {
    ...
    private static final String TAG = list_complain_by_note.class.getSimpleName();

    private static String url_select     = Server.URL + "note/list_padma_complain_by_nmr_note2/";
    ...
    String tahun="",bulan="",complain_status = "all",nmr_note="",status_tiket = "All";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new adapter_cust_service2(list_complain_by_note.this, itemList);
    ...
    private void callVolley(final int start,final String tiketStatus) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(list_complain_by_note.this,
        ...
        if(onLoading==true) {
            ...
            String url_server = url_select + String.valueOf(start) + "/" + nmr_note+"/"+tiketStatus;
            ...
            JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    if (response.length() > 0) {
                        ...
                        if (start == 0) {
                            ...
                            if (onLoading == true) {
                                Toast.makeText(list_complain_by_note.this, "No More Items Available For ", Toast.LENGTH_SHORT).show();
                            }
                            onLoading = false;
                        }
                    }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    swipe.setRefreshing(false);
                    progressDialog.dismiss();
                    Toast.makeText(list_complain_by_note.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    textNoData.setVisibility(View.VISIBLE);
                    Toast.makeText(list_complain_by_note.this, "Data komplain kosong ", Toast.LENGTH_SHORT).show();
    ...
    void showEditCustomerDialog(final Data_cust_service customer) {
        ...
        final ItemImageText[] items = {
                ...
                new ItemImageText("Remove Ticket", "", "")
        };
    ...
    private void DialogFilter(String button) {
        dialog = new AlertDialog.Builder(list_complain_by_note.this);
    ...
    private void pilihAct() {
        ...
        LinearLayout layout = new LinearLayout(list_complain_by_note.this);
        ...
        final TableLayout tblRange = new TableLayout(list_complain_by_note.this);
        tblRange.setColumnStretchable(0, true);
        //tblRange.setColumnStretchable(1, true);
        //tblRange.setColumnStretchable(2, true);

        TableRow row = new TableRow(list_complain_by_note.this);
        ...
        TextView txt_camera = new TextView(list_complain_by_note.this);
        txt_camera.setText("From Existing Ticket");
        ...
        txt_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(list_complain_by_note.this, list_existing_ticket.class);
        ...
        final TableRow row2 = new TableRow(list_complain_by_note.this);
        row2.setBackgroundColor(getResources().getColor(R.color.white));

        TextView txt_galery = new TextView(list_complain_by_note.this);
        txt_galery.setText("Create New Ticket");
        ...
        txt_galery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(list_complain_by_note.this, add_note_ticket.class);
                //intent.putExtra("act", "edit_outlet");
                intent.putExtra("act", "add_complain");
                intent.putExtra("nmr_note", nmr_note);
                startActivityForResult(intent,1);
        ...
        // set title dialog
        alertDialogBuilder.setTitle("Add Ticket From ");
