...
public class add_note_ticket extends AppCompatActivity {
    ...
    private static final String TAG = add_note_ticket.class.getSimpleName();

    private static String url_post_complain     = Server.URL + "note/post_save_ticket_note";
    ...
    String id_company="",nama_company="",nmr_project="",jml_subproject="0",nmr_subproject="",global_pic2="";
    ...
    private void getListComplainTo() {
        String url_server = url_list_master_complain_to;
    ...
    private void getDeskripsi(final String id_complainn) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(add_note_ticket.this,
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    Toast.makeText(add_note_ticket.this, "Tidak bisa mendapatkan data ", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                }
                // notifikasi adanya perubahan data pada adapter
                //photoAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(TAG, "Error: " + error.getMessage());
                Toast.makeText(add_note_ticket.this, "Error Connection ", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
    ...
    private void callList1() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            TableRow row = new TableRow(add_note_ticket.this);
            ...
            TextView txt_nmr = new TextView(add_note_ticket.this);
            txt_nmr.setText("" + nmr);
    ...
    private void callList2() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            TextView txt_keterangan = new TextView(add_note_ticket.this);
            ...
            ImageView img_coaching = new ImageView(add_note_ticket.this);
