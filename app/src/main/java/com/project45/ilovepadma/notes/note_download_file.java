...
import com.project45.ilovepadma.project.FileDownloader;
...
public class note_download_file extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = note_download_file.this;

        StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
        StrictMode.setVmPolicy(builder.build());

        if ( ContextCompat.checkSelfPermission( note_download_file.this, Manifest.permission.WRITE_EXTERNAL_STORAGE ) != PackageManager.PERMISSION_GRANTED ) {
            ActivityCompat.requestPermissions( note_download_file.this, new String[] {  Manifest.permission.WRITE_EXTERNAL_STORAGE  },
                    11 );
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                // Output stream
                OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory() + "/ilv_note/" + namaFileFlowMenu);
        ...
        protected void onPostExecute(String file_url) {
            ...
            Toast.makeText(getApplicationContext(), "Download File Success, check folder ilv_note untuk melihat file.", Toast.LENGTH_LONG).show();
            OpenFileAlert();
        }
    ...
    {
        File pdfFile = new File(Environment.getExternalStorageDirectory() + "/ilv_note/" + namaFileFlowMenu);  // -> filename = maven.pdf
        ...
        /*
        Intent intent = new Intent(Intent.ACTION_VIEW);
        File file = new File(Environment.getExternalStorageDirectory() + "/ilv_note/" + pdfFile);
    ...
    private void OpenFileAlert(){
        ...
        // set title dialog
        alertDialogBuilder.setTitle("File Note");

        // set pesan dari dialog
        alertDialogBuilder
                .setMessage("File berhasil didownload di folder ilv_note. Apakah anda ingin membuka file ")
