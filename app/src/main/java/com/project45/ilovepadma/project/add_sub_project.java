...
public class add_sub_project extends AppCompatActivity {
    ...
    private static final String TAG = add_sub_project.class.getSimpleName();
    ...
    private static String url_save_project    = Server.URL + "project/post_save_sub_project";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_sub_project);
        ...
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(add_sub_project.this, R.array.slc_jenis_project, android.R.layout.simple_spinner_item);
    ...
    private void getListDivisi() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(add_sub_project.this,
