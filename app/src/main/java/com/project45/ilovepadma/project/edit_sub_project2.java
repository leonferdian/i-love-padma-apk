...
public class edit_sub_project2 extends AppCompatActivity {
    ...
    private static final String TAG = edit_sub_project2.class.getSimpleName();
    ...
    private static String url_get_detail_sub_project    = Server.URL + "project/list_sub_project_detail/";
        ...
        txt_file_flow_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txt_file_flow_menu.getText().equals("no file"))
                {
                    ...
                    Intent intent = new Intent(edit_sub_project2.this, project_file_pendukung2.class);
    ...
    private void getListDivisi() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(edit_sub_project2.this,
    ...
    private void getProject(final String nmrProject) {
        ...
        String url_server = url_get_detail_sub_project+nmrProject;
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
                ...
                if(response.length()>0) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            nmr_project = obj.getString("nmr_project");

                            jenis_project=obj.getString("jenis_project");
                            divisi=obj.getString("divisi");
                            nama_project=obj.getString("nama_project");
                            main_project=obj.getString("main_project");

                            createBy=obj.getString("create_by");
                            id_sub_project=obj.getString("id");
                            nmr_sub_project = obj.getString("nmr_sub_project");
                            sub_project =obj.getString("sub_project");
                            member = obj.getString("member");
                            flow_menu = obj.getString("flow_menu");
                            flow_design = obj.getString("flow_design");
                            flow_output = obj.getString("flow_output");
                            table_korelasi = obj.getString("table_korelasi");
                            ...
                            ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(edit_sub_project2.this, R.array.slc_jenis_project, android.R.layout.simple_spinner_item);
                    ...
                    Toast.makeText(edit_sub_project2.this, "Tidak bisa mendapatkan data ", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(TAG, "Error: " + error.getMessage());
                Toast.makeText(edit_sub_project2.this, "Error Connection ", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
