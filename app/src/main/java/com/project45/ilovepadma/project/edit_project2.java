...
public class edit_project2 extends AppCompatActivity {
    ...
    private static final String TAG = edit_project2.class.getSimpleName();
    ...
    private static String url_detail_project    = Server.URL + "project/list_detail_project2/";
    ...
    Button btn_flow_menu,btn_flow_design,btn_flow_output,btn_korelasi_table,btn_del;
    ...
    int randomNumber;
    String id_project = "",timeStamp="",id_divisi = "",nama_divisi = "",act="",memberProject="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_project2);
        ...
        multi_member_project.setEnabled(false);
        txt_status_project.setEnabled(false);
        ...
        btn_flow_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txt_file_flow_menu.getText().equals("no file"))
                {
                    ...
                    Intent intent = new Intent(edit_project2.this, project_file_pendukung2.class);
    ...
    private void getListDivisi() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(edit_project2.this,
    ...
    private void get_detail_project(final String idProject){
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, url_edit, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(edit_project2.this, R.array.slc_jenis_project, android.R.layout.simple_spinner_item);
                        ...
                        Toast.makeText(edit_project2.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                    }
                } catch (JSONException e) {
                    // JSON error
                    e.printStackTrace();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(edit_project2.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
