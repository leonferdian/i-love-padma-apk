...
public class adapter_list_timeline_pe extends BaseAdapter {
    ...
    public adapter_list_timeline_pe(Activity activity, List<Data_join_visit> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_timeline_ilv, parent, false);
        ...
        holder.txt_sales_name.setText(data.getnama_salesman());
        if(data.getjenis_file().equals("video"))
        {
            holder.cart_prtitle.setText("include video");
            holder.cart_prtitle.setTextColor(Color.parseColor("#1e8dee"));
        }
        else {
            holder.cart_prtitle.setText("Image only");
            //holder.cart_prtitle.setTextColor(Color.parseColor("#0f1418"));
        }
        ...
        */
        ...
        holder.cart_prprice.setText(Html.fromHtml(data.getvol_tot_order(),new URLImageParser(holder.cart_prprice, context),null));
