...
public class adapter_point extends BaseAdapter {
    ...
    public adapter_point(Activity activity, List<Data_point> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_point, parent, false);
        ...
        holder.task_name.setText(data.getisi_komen());
