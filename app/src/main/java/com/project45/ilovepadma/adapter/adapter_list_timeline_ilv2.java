...
public class adapter_list_timeline_ilv2 extends BaseAdapter {
    ...
    public adapter_list_timeline_ilv2(Activity activity, List<Data_join_visit> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_timeline_ilv_tnp_image, parent, false);
        ...
        {
            holder.txt_kategori.setText("Kategori: tiket");
        }
        else {
            holder.txt_kategori.setText("Kategori: " + data.getalamat_cust());
        }
