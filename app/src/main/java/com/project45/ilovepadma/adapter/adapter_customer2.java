...
public class adapter_customer2 extends BaseAdapter {
    ...
    public adapter_customer2(Activity activity, List<Data_customer> items, AdapterCallback callback) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_customer2, parent, false);
