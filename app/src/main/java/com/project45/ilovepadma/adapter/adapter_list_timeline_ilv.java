...
public class adapter_list_timeline_ilv extends BaseAdapter {
    ...
    public adapter_list_timeline_ilv(Activity activity, List<Data_join_visit> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(data.getalamat_cust().equals("complain"))
        {
            holder.cart_prtitle.setText("Kategori: tiket");
        }
        else {
            holder.cart_prtitle.setText("Kategori: " + data.getalamat_cust());
        }
