...
public class list_result_outlet extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_customer3.AdapterCallback{
    private static final String TAG = list_profiling_reject_outlet.class.getSimpleName();
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";
    private static String url_select_approved_oultet = Server.URL + "outlet/list_approved_outlet/";
    private static String url_post_save_outlet_dms3 = Server.URL + "outlet/post_save_outlet_dms3";
    AlertDialog.Builder dialog;
    EditText edt_search, txt_id_dms3, txt_id_outlet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_result_outlet);
        ...
        gps = new GPSTracker(list_result_outlet.this, list_result_outlet.this);
        ...
        adapter = new adapter_customer3(list_result_outlet.this,itemList, list_result_outlet.this);
    ...
    private void callVolley(final int start,final double lt,final double lg,final String filterOutlet) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(list_result_outlet.this,
        ...
        if(onLoading==true) {
            ...
            String url_server = url_select_approved_oultet + String.valueOf(start)+"/"+lt+"/"+lg + "/" + filterOutlet;
...
//                                item.setSegment_level_1(obj.getString("sub_segment"));
                        ...
                        if (start == 0) {
                            ...
                            if (onLoading == true) {
                                Toast.makeText(list_result_outlet.this, "No More Items Available For ", Toast.LENGTH_SHORT).show();
                            }
                            onLoading = false;
                        }
                    }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    swipe.setRefreshing(false);
                    progressDialog.dismiss();
                    Toast.makeText(list_result_outlet.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void add_result_dealing_dialog(String id_outlet) {
        dialog = new AlertDialog.Builder(list_result_outlet.this);
        inflater = getLayoutInflater();
        dialogView = inflater.inflate(R.layout.add_outlet_id_dms3, null);
        ...
        txt_id_dms3 = dialogView.findViewById(R.id.txt_id_dms3);
        ...
        dialog2.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(TextUtils.isEmpty(txt_id_dms3.getText())){
                    Toast.makeText(getApplicationContext(), "Wajib mengisi ID DMS3!", Toast.LENGTH_LONG).show();
                } else {
                    save_result_dealing_outlet(txt_id_outlet.getText().toString(),txt_id_dms3.getText().toString());
                    dialog2.dismiss();
                }
            }
        });
    ...
    private void save_result_dealing_outlet(String id_outlet,String id_dms3){
        final ProgressDialog progressDialog = new ProgressDialog(list_result_outlet.this,
                R.style.AppTheme_Dark_Dialog);
        progressDialog.setIndeterminate(true);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_post_save_outlet_dms3 , new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(getApplicationContext(), "Sukses Save Existing Outlet", Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                        callVolley(0,latitude,longitude,filter_outlet);
                    } else {
