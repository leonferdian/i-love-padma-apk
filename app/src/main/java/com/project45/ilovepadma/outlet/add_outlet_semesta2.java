...
public class add_outlet_semesta2 extends AppCompatActivity {
    CardView cv_add_listed_outlet, cv_add_profiling_outlet, cv_add_dealing_outlet, cv_add_result_dealing, cv_add_existing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv_add_existing = findViewById(R.id.cv_add_existing);
...
//                intent.putExtra("act", "add_outlet");
        ...
        cv_add_existing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(add_outlet_semesta2.this, list_result_outlet.class);
//                intent.putExtra("act", "add_outlet");
                startActivityForResult(intent, 1);
            }
        });
