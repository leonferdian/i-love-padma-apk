...
public class list_listed_outlet extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_customer3.AdapterCallback{
    private static final String TAG = list_outlet2.class.getSimpleName();
    private static String url_select_listed_oultet = Server.URL + "outlet/list_listed_outlet/";
    EditText edt_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_listed_outlet);
        ...
        gps = new GPSTracker(list_listed_outlet.this, list_listed_outlet.this);
        ...
        adapter = new adapter_customer3(list_listed_outlet.this,itemList, list_listed_outlet.this);
    ...
    public void onCustomerOnClick(int position, Data_customer customer) {
        Intent intent = new Intent(list_listed_outlet.this, add_profiling_outlet.class);
        intent.putExtra("id_outlet", customer.getcode_customer());
    ...
    private void callVolley(final int start,final double lt,final double lg,final String filterOutlet) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(list_listed_outlet.this,
        ...
        if(onLoading==true) {
            ...
            String url_server = url_select_listed_oultet + String.valueOf(start)+"/"+lt+"/"+lg + "/" + filterOutlet;
...
//                                item.setSegment_level_1(obj.getString("sub_segment"));
                        ...
                        if (start == 0) {
                            ...
                            if (onLoading == true) {
                                Toast.makeText(list_listed_outlet.this, "No More Items Available For ", Toast.LENGTH_SHORT).show();
                            }
                            onLoading = false;
                        }
                    }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    swipe.setRefreshing(false);
                    progressDialog.dismiss();
                    Toast.makeText(list_listed_outlet.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                }
            });
