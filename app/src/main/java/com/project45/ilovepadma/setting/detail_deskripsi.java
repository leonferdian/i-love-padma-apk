...
public class detail_deskripsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_jam_awal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(detail_deskripsi.this, new TimePickerDialog.OnTimeSetListener() {
    ...
    private void postDeskripsi(){
        ...
        if(detail_aktifitas.equals("")){
            ...
            final ProgressDialog progressDialog = new ProgressDialog(detail_deskripsi.this,
