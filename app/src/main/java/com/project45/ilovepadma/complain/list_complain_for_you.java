...
public class list_complain_for_you extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_cust_service2.CustomerListener {
    ...
    private static final String TAG = list_complain_for_you.class.getSimpleName();

    //private static String url_select     = Server.URL + "cust_service/list_padma_complain_for_you/";
    private static String url_select     = Server.URL + "cust_service/list_padma_complain_for_you2/";
    private static String url_select_complain_with_filter     = Server.URL + "cust_service/list_padma_complain_for_you_by_filter/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new adapter_cust_service2(list_complain_for_you.this, itemList);
    ...
    private void callVolley(final int start) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(list_complain_for_you.this,
        ...
        if(onLoading==true) {
            ...
            JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    swipe.setRefreshing(false);
                    progressDialog.dismiss();
                    Toast.makeText(list_complain_for_you.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        adb.setAdapter(imageTextAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface d, int n) {
                if(items[n].text.equals("Detail")){
                    ...
                    Intent intent = new Intent(list_complain_for_you.this, detail_complain_for_you.class);
    ...
    private void DialogFilter(String button) {
        dialog = new AlertDialog.Builder(list_complain_for_you.this);
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    textNoData.setVisibility(View.VISIBLE);
                    Toast.makeText(list_complain_for_you.this, "Data komplain kosong ", Toast.LENGTH_SHORT).show();
