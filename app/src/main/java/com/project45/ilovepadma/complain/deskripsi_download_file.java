...
public class deskripsi_download_file extends AppCompatActivity {

    private static String url_file_project     = Server.URL2 + "image_upload/list_foto_complain/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = deskripsi_download_file.this;

        StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
        StrictMode.setVmPolicy(builder.build());

        if ( ContextCompat.checkSelfPermission( deskripsi_download_file.this, Manifest.permission.WRITE_EXTERNAL_STORAGE ) != PackageManager.PERMISSION_GRANTED ) {
            ActivityCompat.requestPermissions( deskripsi_download_file.this, new String[] {  Manifest.permission.WRITE_EXTERNAL_STORAGE  },
                    11 );
