...
public class list_complain extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_cust_service.CustomerListener {
    ...
    private static final String TAG = list_complain.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new adapter_cust_service(list_complain.this, itemList);
    ...
    private void callVolley(final int start) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(list_complain.this,
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    if(start == 0) {
                        ...
                        Toast.makeText(list_complain.this, "No More Items Available For ", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                swipe.setRefreshing(false);
                progressDialog.dismiss();
                Toast.makeText(list_complain.this, "No More Items Available", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    textNoData.setVisibility(View.VISIBLE);
                    Toast.makeText(list_complain.this, "Data komplain kosong ", Toast.LENGTH_SHORT).show();
        ...
        adb.setAdapter(imageTextAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface d, int n) {
                if(items[n].text.equals("Detail")){
                    ...
                    Intent intent = new Intent(list_complain.this, detail_complain.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_complain_menu) {
            ...
            Intent intent = new Intent(list_complain.this, add_complain.class);
    ...
    private void DialogFilter(String button) {
        dialog = new AlertDialog.Builder(list_complain.this);
