...
import com.project45.ilovepadma.adapter.adapter_list_respon;
...
import com.project45.ilovepadma.timeline.timeline_comment;
...
public class list_respon extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_list_respon.ListPoint{
    ...
    private static final String TAG = list_respon.class.getSimpleName();
    ...
    adapter_list_respon adapter;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.list_respon2);
        ...
        adapter = new adapter_list_respon(list_respon.this, itemList);
        ...
        //Toast.makeText(list_respon.this, "complain_to "+complain_to, Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_so) {
            ...
            //Intent intent = new Intent(list_respon.this, add_respon_complain.class);
            Intent intent = new Intent(list_respon.this, add_respon_complain_multi_file.class);
    ...
    private void getDeskripsi2(final String id_complainn) {

        final ProgressDialog progressDialog = new ProgressDialog(list_respon.this,
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
                ...
                if(response.length()>0) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            jv.setdate_create(obj.getString("date_create"));
                            jv.setuser_login(id_user);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                swipe.setRefreshing(false);
                progressDialog.dismiss();
                Toast.makeText(list_respon.this, "No More Items Available", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    Toast.makeText(list_respon.this, "Data Respon Kosong ", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                }
                // notifikasi adanya perubahan data pada adapter
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(TAG, "Error: " + error.getMessage());
                Toast.makeText(list_respon.this, "Error Connection ", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
    ...
    private void callList1() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            TableRow row = new TableRow(list_respon.this);
            ...
            TextView txt_nmr = new TextView(list_respon.this);
            txt_nmr.setText("" + nmr);
            ...
            TextView txt_keterangan = new TextView(list_respon.this);
            ...
            TextView txt_create_by = new TextView(list_respon.this);
            ...
            ImageView imgOutlet = new ImageView(list_respon.this);
            ...
            imgOutlet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(list_respon.this, detail_foto.class);
            ...
            ImageView img_coaching = new ImageView(list_respon.this);
    ...
    void showEditCustomerDialog(final Data_work_report berita) {
        ...
        adb.setAdapter(imageTextAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface d, int n) {
                if(items[n].text.equals("Delete")){


                    if(!complain_status.equals("close")) {
                        CloseAlert(berita.getid());
                    }
                    else{
                        Toast.makeText(getApplicationContext(), "Anda tidak bisa menghapus respon. complain sudah diclose ", Toast.LENGTH_LONG).show();
                    }
                ...
                else if(items[n].text.equals("Detail")){
                    Intent intent = new Intent(getApplicationContext(), detail_respon_complain_multi_file.class);
                    intent.putExtra("act_form", "view_deskripsi");
                    intent.putExtra("keterangan", berita.getketerangan());
                    intent.putExtra("complain_foto", berita.getcomplain_foto());
                    intent.putExtra("id_complain", id_complain);
                    intent.putExtra("id_det_complain", berita.getid());
    ...
    void showEditCustomerDialog2(final Data_work_report berita) {
    ...
    @Override
    public void onSuratOnClick(int position, Data_work_report berita) {
        if(berita.getid_user().equals(berita.getuser_login())) {
            showEditCustomerDialog(berita);
        }
        else{
            showEditCustomerDialog2(berita);
        }

    }

    @Override
    public void onImageOnClick(int position, Data_work_report berita) {
        Intent intent = new Intent(list_respon.this, detail_foto.class);
        intent.putExtra("sku", "Foto Respon Complain");
        intent.putExtra("file_foto", berita.getcomplain_foto());
        intent.putExtra("tgl_buat", "");
        intent.putExtra("act", "foto_respon_complain");
        //startActivity(intent);
        startActivityForResult(intent, 1);
