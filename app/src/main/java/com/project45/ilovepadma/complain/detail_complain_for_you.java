...
public class detail_complain_for_you extends AppCompatActivity {

    String id_user, username,bm,email,jabatan,employee_id_dms3="",id_complain="",timeStamp="",act_form="",tanggal_act="",complain_purpose="",
            complain_status = "",jenis_complain = "",nmr_project="",nmr_sub_project="",complain_to="",id_company="",nama_company="",szId="";
    int randomNumber;
    ...
    private static final String TAG = detail_complain_for_you.class.getSimpleName();
    ...
    private static String url_select_l1     = Server.URL + "cust_service/list_l1_proker/";
    private static String url_select_l2     = Server.URL + "cust_service/list_l2_proker/";
    private static String url_select_l3     = Server.URL + "cust_service/list_l3_proker/";
    private static String url_post_update_proker     = Server.URL + "cust_service/post_update_proker_tiket";
    ...
    Button btn_deskripsi,btn_update_proker;
    ...
    List<Data_cust_service> itemListL1 = new ArrayList<Data_cust_service>();
    List<Data_cust_service> itemListL2 = new ArrayList<Data_cust_service>();
    List<Data_cust_service> itemListL3 = new ArrayList<Data_cust_service>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_complain_for_you);
        ...
        btn_update_proker = findViewById(R.id.btn_update_proker);
        ...
        if (detComplain != null) {
            ...
            complain_to = detComplain.gettiket_creator();
            ...
            if(jenis_complain.equals("Proak")){
                ...
                txt_nmr_project.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(detail_complain_for_you.this, edit_project2.class);
                ...
                txt_nmr_subproject.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(detail_complain_for_you.this, edit_sub_project2.class);
                        //intent.putExtra("act", "edit_outlet");
                        intent.putExtra("act", "edit_project");
        ...
        btn_deskripsi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(detail_complain_for_you.this, list_respon.class);
                //intent.putExtra("act", "edit_outlet");
        ...
        txt_l1.setOnClickListener(new View.OnClickListener() {
        ...
        txt_l2.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                String l1 = txt_l1.getText().toString();
                getListL2(v,l1);

            }
        });

        txt_l3.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                String l1 = txt_l1.getText().toString();
                String l2 = txt_l2.getText().toString();
                getListL3(v,l1,l2);

            }
        });

        btn_update_proker.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                proc_update_proker_tiket(szId);
    ...
    private void pilihAct() {
        ...
        LinearLayout layout = new LinearLayout(detail_complain_for_you.this);
        ...
        final TableLayout tblRange = new TableLayout(detail_complain_for_you.this);
        tblRange.setColumnStretchable(0, true);
        //tblRange.setColumnStretchable(1, true);
        //tblRange.setColumnStretchable(2, true);

        TableRow row = new TableRow(detail_complain_for_you.this);
        ...
        TextView txt_accepted=new TextView(detail_complain_for_you.this);
        txt_accepted.setText("Accept");
        ...
        final TableRow row2 = new TableRow(detail_complain_for_you.this);
        row2.setBackgroundColor(getResources().getColor(R.color.white));

        TextView txt_rejected=new TextView(detail_complain_for_you.this);
        txt_rejected.setText("Reject");
        txt_rejected.setTextColor(getResources().getColor(R.color.white));
        txt_rejected.setBackgroundResource(R.color.page_tbl_total);
        txt_rejected.setTextSize(10);
        txt_rejected.setGravity(Gravity.CENTER);
        txt_rejected.setPadding(10,0,10,0);
        txt_rejected.setTypeface(null, Typeface.BOLD);
        txt_rejected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                proc_edit_deskripsi("reject");
            }
        });

        // add to row
        row2.addView(txt_rejected, params);
        tblRange.addView(row2);

        final TableRow row3 = new TableRow(detail_complain_for_you.this);
        row3.setBackgroundColor(getResources().getColor(R.color.white));

        TextView txt_proses=new TextView(detail_complain_for_you.this);
        ...
        final TableRow row4 = new TableRow(detail_complain_for_you.this);
        row4.setBackgroundColor(getResources().getColor(R.color.white));

        TextView txt_finish=new TextView(detail_complain_for_you.this);
    ...
    private void getDeskripsi(final String id_complainn) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(detail_complain_for_you.this,
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    Toast.makeText(detail_complain_for_you.this, "Tidak bisa mendapatkan data ", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(detail_complain_for_you.this, "Error Connection ", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
    ...
    private void callList1() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            TextView txt_nmr = new TextView(detail_complain_for_you.this);
            txt_nmr.setText("" + nmr);
    ...
    private void callList2() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            TextView txt_keterangan = new TextView(detail_complain_for_you.this);
            ...
            txt_keterangan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("complain_from", "for_you");
            ...
            /*
            ImageView img_coaching = new ImageView(detail_complain_for_you.this);
            img_coaching.setImageBitmap(BitmapFactory.decodeResource(getResources(),R.drawable.ic_channel_48_white));
    ...
    private void getListL1(final View v) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(detail_complain_for_you.this,
                R.style.AppTheme_Dark_Dialog);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Loading Get L1...");
        progressDialog.show();

        String url_server = url_select_l1+id_user+"/"+id_company;
        Log.d("url_l1", url_server);
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                Log.d(TAG, response.toString());
                ...
                if(response.length()>0) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            JSONObject obj = response.getJSONObject(i);
                            Data_cust_service rute = new Data_cust_service();
                            rute.setl1(obj.getString("l1"));
                            itemListL1.add(rute);
    ...
    public void getDialogl1(final View v) {
        final String[] array = new String[itemListL1.size()];

        for (int i = 0; i < itemListL1.size(); i++) {
            array[i] = itemListL1.get(i).getl1();
        }
    ...
    private void getListL2(final View v, final String l1) {

        itemListL2.clear();
        final String Ll1 = l1.replace(" ", "%20");
        final ProgressDialog progressDialog = new ProgressDialog(detail_complain_for_you.this,
                R.style.AppTheme_Dark_Dialog);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Loading Get L2...");
        progressDialog.show();

        String url_server = url_select_l2+id_user+"/"+id_company+"/"+Ll1;
        Log.d("url_l2", url_server);
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                Log.d(TAG, response.toString());
    ...
    public void getDialogl2(final View v) {
        final String[] array = new String[itemListL2.size()];

        for (int i = 0; i < itemListL2.size(); i++) {
            array[i] = itemListL2.get(i).getl2();
        }
    ...
    private void getListL3(final View v, final String l1, final String l2) {

        itemListL3.clear();
        final String Ll1 = l1.replace(" ", "%20");
        final String Ll2 = l2.replace(" ", "%20");
        final ProgressDialog progressDialog = new ProgressDialog(detail_complain_for_you.this,
                R.style.AppTheme_Dark_Dialog);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Loading Get L3...");
        progressDialog.show();

        String url_server = url_select_l3+id_user+"/"+id_company+"/"+Ll1+"/"+Ll2;
        Log.d("url_l3", url_server);
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                Log.d(TAG, response.toString());
    ...
    public void getDialogl3(final View v) {
        final String[] array = new String[itemListL3.size()];

        for (int i = 0; i < itemListL3.size(); i++) {
            array[i] = itemListL3.get(i).getl3();
        }
    ...
    private void proc_update_proker_tiket(final String idTiket){

        Log.e(TAG, "idTiket: " + idTiket);

        final ProgressDialog progressDialog = new ProgressDialog(detail_complain_for_you.this,
                R.style.AppTheme_Dark_Dialog);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Update Proker...");
        progressDialog.show();

        String l1 = txt_l1.getText().toString();
        String l2 = txt_l2.getText().toString();
        String l3 = txt_l3.getText().toString();

        StringRequest strReq = new StringRequest(Request.Method.POST, url_post_update_proker, new Response.Listener<String>() {
