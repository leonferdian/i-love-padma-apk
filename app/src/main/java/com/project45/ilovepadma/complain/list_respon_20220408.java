...
public class list_respon_20220408 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_list_respon.ListPoint{
    ...
    private static final String TAG = list_respon_20220408.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new adapter_list_respon(list_respon_20220408.this, itemList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_so) {
            ...
            Intent intent = new Intent(list_respon_20220408.this, add_respon_complain_multi_file.class);
    ...
    private void getDeskripsi2(final String id_complainn) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(list_respon_20220408.this,
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                swipe.setRefreshing(false);
                progressDialog.dismiss();
                Toast.makeText(list_respon_20220408.this, "No More Items Available", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    Toast.makeText(list_respon_20220408.this, "Data Respon Kosong ", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                }
                // notifikasi adanya perubahan data pada adapter
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d(TAG, "Error: " + error.getMessage());
                Toast.makeText(list_respon_20220408.this, "Error Connection ", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
    ...
    private void callList1() {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            TableRow row = new TableRow(list_respon_20220408.this);
            ...
            TextView txt_nmr = new TextView(list_respon_20220408.this);
            txt_nmr.setText("" + nmr);
            ...
            TextView txt_keterangan = new TextView(list_respon_20220408.this);
            ...
            TextView txt_create_by = new TextView(list_respon_20220408.this);
            ...
            ImageView imgOutlet = new ImageView(list_respon_20220408.this);
            ...
            imgOutlet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(list_respon_20220408.this, detail_foto.class);
            ...
            ImageView img_coaching = new ImageView(list_respon_20220408.this);
