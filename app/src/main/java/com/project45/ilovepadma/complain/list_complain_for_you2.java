...
public class list_complain_for_you2 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_cust_service2.CustomerListener {
    ...
    private static final String TAG = list_complain_for_you2.class.getSimpleName();

    private static String url_select     = Server.URL + "cust_service/list_padma_complain_for_you/";
    private static String url_select_complain_with_filter     = Server.URL + "cust_service/list_padma_report_complain/";

    List<Data_cust_service> itemList = new ArrayList<Data_cust_service>();
    adapter_cust_service2 adapter;

    LayoutInflater inflater;
    String tahun="",bulan="",complain_status = "all",complain_from="",id_company="",nama_company="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tahun= intentku.getStringExtra("tahun");;
        bulan= intentku.getStringExtra("bulan");
        id_user= intentku.getStringExtra("idUser");
        ...
        adapter = new adapter_cust_service2(list_complain_for_you2.this, itemList);
        ...
        adb.setAdapter(imageTextAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface d, int n) {
                if(items[n].text.equals("Detail")){
                    ...
                    Intent intent = new Intent(list_complain_for_you2.this, detail_complain_for_you.class);
    ...
    private void DialogFilter(String button) {
        dialog = new AlertDialog.Builder(list_complain_for_you2.this);
    ...
    private void listComplainWithFilter(final String tahunn, final String bulann, final String status_complain) {
        ...
        itemList.clear();
        textNoData.setVisibility(View.GONE);
        final ProgressDialog progressDialog = new ProgressDialog(list_complain_for_you2.this,
        ...
        String url_server       = url_select_complain_with_filter+id_user+"/"+tahunn+"/"+bulann+"/"+status_complain+"/"+complain_from+"/"+id_company;
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_server, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(response.length()>0) {
                    ...
                    Toast.makeText(list_complain_for_you2.this, "Data komplain kosong ", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                swipe.setRefreshing(false);
                progressDialog.dismiss();
                Toast.makeText(list_complain_for_you2.this, "No More Items Available", Toast.LENGTH_SHORT).show();
            }
        });
