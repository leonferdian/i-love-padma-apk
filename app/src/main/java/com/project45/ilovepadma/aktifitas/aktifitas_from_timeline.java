...
public class aktifitas_from_timeline extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,adapter_work_report_bydate.ListWR {

    public static final String TAG_ID = "id";
    public static final String TAG_USERNAME = "username";
    public static final String TAG_EMAIL = "email";
    public static final String my_shared_preferences = "my_shared_preferences";
    private static final String TAG = aktifitas_from_timeline.class.getSimpleName();
    String id_user, username,work_report,email,tgl_report,id_aktifitas="",nmr_aktifitas="";
    ...
    private static String url_list_work_report_by_date     = Server.URL + "aktifitas/list_aktifitas_by_nmr_aktifitas/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nmr_aktifitas = intentku.getStringExtra("nmr_aktifitas");
        ...
        adapter = new adapter_work_report_bydate(aktifitas_from_timeline.this, itemList);
    ...
    private void callVolley() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(aktifitas_from_timeline.this,
        ...
        String url_server       = url_list_work_report_by_date+nmr_aktifitas;
        ...
        adb.setAdapter(imageTextAdapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface d, int n) {
                ...
                if(items[n].text.equals("Edit")){
                    Intent intent = new Intent(aktifitas_from_timeline.this, edit_deskripsi.class);
